...
download_ss() {
    local version=$1
    local arch=$2
    local url="https://o0o.net2ftp.pp.ua/https://github.com/shadowsocks/shadowsocks-rust/releases/download/v${version}"
    local filename=""
...
Update_Shell() {
    ...
    if ! wget --no-check-certificate -O ${temp_file} "https://o0o.net2ftp.pp.ua/https://raw.githubusercontent.com/jinqians/ss-2022.sh/refs/heads/main/ss-2022.sh"; then
...
install_shadowtls() {
    ...
    # 下载 ShadowTLS 脚本
    wget -N --no-check-certificate https://o0o.net2ftp.pp.ua/https://raw.githubusercontent.com/jinqians/ss-2022.sh/refs/heads/main/shadowtls.sh
