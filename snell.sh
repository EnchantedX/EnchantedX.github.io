    ...
    if [ "$version" = "v5" ]; then
        ...
        case ${arch} in
            ...
            "i386"|"i686")
                ...
                ;;
            "aarch64"|"arm64")
                echo "https://o0o.net2ftp.pp.ua/https://dl.nssurge.com/snell/snell-server-${SNELL_VERSION}-linux-aarch64.zip"
                ;;
            "armv7l"|"armv7")
                echo "https://o0o.net2ftp.pp.ua/https://dl.nssurge.com/snell/snell-server-${SNELL_VERSION}-linux-armv7l.zip"
                ;;
            *)
